...
GITHUB_API_SPEC = CodeHostingSpec(
    ...
    git_config_keys=CodeHostingGitConfigKeys(
        ...
        base_organization='machete.github.baseOrganization',
        base_repository='machete.github.baseRepository',
        base_remote='machete.github.baseRemote',
        ...
        retrieve_by_author='machete.github.retrieveByAuthor',
    )
)
