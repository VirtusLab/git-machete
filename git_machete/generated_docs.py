...
long_docs: Dict[str, str] = {
   ...
   """,
    "anno": """
        <b>Usage:</b><b>
           ...
           git machete anno --sync-gitlab-mrs</b>
   ...
   """,
    "gitlab": """
        ...
        </dim>See <b>Git config keys</b> below in case the target repository cannot be detected automatically (for example, in case of GitLab Enterprise).
        ...
        <b>Subcommands:</b>
           ...
           `create-mr [--draft] [--title=<title>] [--yes]`:
              ...
              If `.git/info/description` or `.gitlab/pull_request_template.md` file is present, its contents are used as MR description.
           ...
           `retarget-mr [-b|--branch=<branch>] [--ignore-if-missing]`:
              ...
              Specify the branch for which the associated MR base will be set to its upstream (parent) branch. The current branch is used if the option is absent.
