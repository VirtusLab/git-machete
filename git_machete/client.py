...
class MacheteClient:
    ...
    def get_childless_branches(self):
        parent_branches = self.__down_branches.keys()
        return [branch for branch in self.managed_branches if branch not in parent_branches]
