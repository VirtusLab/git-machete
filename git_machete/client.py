...
class MacheteClient:
    ...
    def status(
        ...
        indent_before_branch_name = ' ' * self.__git.get_indent_len_before_branch_name()
        ...
        def print_line_prefix(branch_: LocalBranchShortName, suffix: str) -> None:
            ...
            for sibling in next_sibling_of_ancestor[:-1]:
                if not sibling:
                    ...
                    out.write(colored(f"{utils.get_vertical_bar()} " + indent_before_branch_name, edge_color[sibling]))
