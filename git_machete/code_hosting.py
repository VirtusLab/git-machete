...
class CodeHostingConfig(NamedTuple):
    client_class: type
    default_domain: str
    display_name: str
    git_config_subsection: str
    ...
    def __str__(self) -> str:
        return f"CodeHostingConfig({self.display_name})"
...
class CodeHostingClient(metaclass=ABCMeta):  # pragma: no cover
    def __init__(self, config: CodeHostingConfig, domain: str, organization: str, repository: str) -> None:
        self._config: CodeHostingConfig = config
