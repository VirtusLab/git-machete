...
from git_machete.git_operations import AnyRevision, LocalBranch
...
class CommandLineOptions:
    ...
    def __init__(self) -> None:
        ...
        self.opt_branch: Optional[LocalBranch] = None
        ...
        self.opt_onto: Optional[LocalBranch] = None
        ...
        self.opt_roots: List[LocalBranch] = list()
