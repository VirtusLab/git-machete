...
GITLAB_API_SPEC = CodeHostingSpec(
    ...
    git_config_keys=CodeHostingGitConfigKeys(
        ...
        base_organization='machete.gitlab.baseNamespace',
        base_repository='machete.gitlab.baseProject',
        base_remote='machete.gitlab.baseRemote',
        ...
        retrieve_by_author='machete.gitlab.retrieveByAuthor',
    )
)
