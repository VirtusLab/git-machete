...
Almost there! In the next part, we'll see how `git-machete` integrates with GitHub and GitLab.

[< Previous: Fast-forwarding with Advance](08-fast-forwarding-with-advance.md) | [Next: GitHub/GitLab Integration >](10-github-gitlab-integration.md)
