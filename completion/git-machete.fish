...
complete -c git-machete -n "__fish_seen_subcommand_from add; and not __fish_seen_subcommand_from --as-root -R --first -f"             -f -l first   -s f                                   -d 'Add the given branch first in the list of the parent's child branches'
