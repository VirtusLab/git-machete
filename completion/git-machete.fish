...
# git machete clean
complete -c git -n "__fish_git_using_command machete; and not __fish_seen_subcommand_from $__mcht_commands"                                                     -f -a clean                          -d 'Synchronize with the remote repository: delete untracked managed branches with no downstream branch, delete unmanaged branches'
...
complete -c git -n "__fish_git_using_command machete; and __fish_seen_subcommand_from github; and not __fish_seen_subcommand_from anno-prs checkout-prs create-pr retarget-pr sync"        -f -a sync  -d 'Synchronize with the remote repository: delete untracked managed branches with no downstream branch, delete unmanaged branches and also checkout open PRs for the current user associated with the Github token'
