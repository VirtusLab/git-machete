...
complete -c git-machete -n "__fish_seen_subcommand_from github; and __fish_seen_subcommand_from anno-prs;     and not __fish_seen_subcommand_from --with-urls"                 -f -l urls                                                 -d 'Include PR URLs in the annotations'
