...
complete -c git-machete -n "__fish_seen_subcommand_from github; and not __fish_seen_subcommand_from anno-prs checkout-prs create-pr restack-pr retarget-pr sync update-pr-descriptions"    -f -a anno-prs                                             -d 'Annotate the branches based on their corresponding GitHub PR numbers and authors'
...
complete -c git-machete -n "__fish_seen_subcommand_from github; and not __fish_seen_subcommand_from anno-prs checkout-prs create-pr restack-pr retarget-pr sync update-pr-descriptions"    -f -a create-pr                                            -d 'Create a PR for the current branch, using the upstream (parent) branch as the PR base'
complete -c git-machete -n "__fish_seen_subcommand_from github; and not __fish_seen_subcommand_from anno-prs checkout-prs create-pr restack-pr retarget-pr sync update-pr-descriptions"    -f -a restack-pr                                           -d '(Force-)push and retarget the PR, without adding code owners as reviewers in the process'
complete -c git-machete -n "__fish_seen_subcommand_from github; and not __fish_seen_subcommand_from anno-prs checkout-prs create-pr restack-pr retarget-pr sync update-pr-descriptions"    -f -a retarget-pr                                          -d 'Set the base of PR for the current branch to upstream (parent) branch, as seen by git machete (see git machete show up)'
...
complete -c git-machete -n "__fish_seen_subcommand_from github; and __fish_seen_subcommand_from create-pr;              and not __fish_seen_subcommand_from --yes -y"                      -f -l yes               -s y                               -d 'Do not ask for confirmation whether to push the branch'
complete -c git-machete -n "__fish_seen_subcommand_from github; and __fish_seen_subcommand_from restack-pr;             and not __fish_seen_subcommand_from --update-related-descriptions" -f -l update-related-descriptions -s U                     -d 'Update the generated sections of PR descriptions that list the upstream and/or downstream PRs'
complete -c git-machete -n "__fish_seen_subcommand_from github; and __fish_seen_subcommand_from retarget-pr"                                                                               -x -l branch -s b       -a '(__machete_managed_branches)'  -d 'Specify the branch for which the associated PR base will be set to its upstream (parent) branch'
...
complete -c git-machete -n "__fish_seen_subcommand_from gitlab; and __fish_seen_subcommand_from create-mr;              and not __fish_seen_subcommand_from --yes -y"                      -f -l yes               -s y                               -d 'Do not ask for confirmation whether to push the branch'
complete -c git-machete -n "__fish_seen_subcommand_from gitlab; and __fish_seen_subcommand_from restack-mr;             and not __fish_seen_subcommand_from --update-related-descriptions" -f -l update-related-descriptions -s U                     -d 'Update the generated sections of MR descriptions that list the upstream and/or downstream MRs'
complete -c git-machete -n "__fish_seen_subcommand_from gitlab; and __fish_seen_subcommand_from retarget-mr"                                                                               -x -l branch -s b       -a '(__machete_managed_branches)'  -d 'Specify the branch for which the associated MR source branch will be set to its upstream (parent) branch'
...
complete -c git-machete -n "__fish_seen_subcommand_from list; and not __fish_seen_subcommand_from addable childless managed slidable slidable-after unmanaged with-overridden-fork-point" -f -a slidable                     -d 'all managed branches that can be slid out with slide-out command (including root branches)'
...
complete -c git-machete -n "__fish_seen_subcommand_from status s"                                                                    -x -l color                    -a "auto always never" -d 'Colorize the output (default: auto)'
...
complete -c git-machete -n "__fish_seen_subcommand_from traverse t"                                                                                        -x -l push-option       -s o                           -d 'Pass the given push option to every git push run during the traversal; can be provided multiple times'
