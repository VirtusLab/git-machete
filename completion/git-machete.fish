...
complete -c git -n "__fish_git_using_command machete; and __fish_seen_subcommand_from github; and __fish_seen_subcommand_from checkout-prs; and not __fish_seen_subcommand_from --my" -f -l my        -d 'Checkout open PRs for the current user associated with the Github token'
