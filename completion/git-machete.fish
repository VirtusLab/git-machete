...
complete -c git-machete -n "__fish_seen_subcommand_from traverse t"                                                                -x -l start-from      -a 'here root first-root'        -d 'Specifies the branch to start the traversal from'
