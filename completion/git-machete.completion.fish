...
complete --command git --condition "__fish_git_using_command machete; and __fish_seen_subcommand_from is-managed" --no-files --arguments '(__fish_git_local_branches)'
...
complete --command git --condition "__fish_git_using_command machete; and __fish_seen_subcommand_from list; and __fish_seen_subcommand_from slidable-after" --no-files --arguments '(__fish_git_local_branches)'
...
complete --command git --condition "__fish_git_using_command machete; and __fish_seen_subcommand_from update; and not __fish_seen_subcommand_from --merge -M" --no-files --long-option fork-point --short-option f --require-parameter --arguments '(__fish_git_local_branches)' --description 'If updating by rebase, specifies the alternative fork point commit after which the rebased part of history is meant to start. Not allowed if updating by merge'
